            ...
            <el-tab-pane label="今日预约" name="first">
                ...
                <div class="yy-doctor">
                    <div class="doctorTime">
                        ...
                        <el-button type="primary" size="mini">{{ doctorData.state }}</el-button>
                        <el-button size="mini">{{ doctorData.date }}</el-button>
                    </div>
                            ...
                            <el-table-column label="姓名" width="180">
                                <template scope="scope">
                                    <div style="display: inline-block;text-align: left;width: 100%">
                                        <span style="margin-left: -7px;line-height: 24px;">
                                            {{ scope.row.yourName }}
                                        </span>
                                        <br>
                                        <span style="margin-left: -10px;" v-if="scope.row.appoint==1||scope.row.tag==1">
                                            {{ scope.row.tel }}
                                        </span>
                                    </div>
                                </template>
                            ...
                            <el-table-column label="操作">
                                <template scope="scope">
                                    <div class="cell cell-blue" v-if="scope.row.appoint==1||scope.row.tag==1">
                                        <span class="el-tag" style="margin-right: 140px;color: white"
                                              v-if="scope.row.appoint==1">就诊中<!----></span>
                                        <!--                                        <i class="el-icon-time" v-if="scope.row.appoint==0"/>-->
                                        <!--                                        <span v-if="scope.row.appoint==0" style="padding-right: 10px;">签到</span>-->
                                        <!--                                        <i class="el-icon-time" v-if="scope.row.appoint==1" style="color:#ACACAC;"/>-->
                                        <!--                                        <span v-if="scope.row.appoint==1"-->
                                        <!--                                              style="color:#ACACAC;padding-right: 10px;">签到</span>-->
                                        <!--                                        <i class="el-icon-edit"/>-->
                                        <!--                                        <span style="padding-right: 10px;">测量</span>-->
                                        <i class="el-icon-document"/>
                                        <span style="padding-right: 10px; ">
                                            <router-link to="/booking/details">
                                                <span style="color: #76BAF9">详情</span>
                                            </router-link>
                                        </span>
                    ...
                    <el-table :data="allAppointData" border style="width: 100%">
                        ...
                        <el-table-column label="支付状态">
                            <template scope="scope">
                                ...
                                <span class="el-tag " style="color: white;background-color: #E9A200;"
                                      v-if="scope.row.pay==0">已支付</span>
                            </template>
                        </el-table-column>
                        <el-table-column label="就诊状态">
                            <template scope="scope">
                                ...
                                <span class="el-tag" style="color: white;background-color: #E9A200;"
                                      v-if="scope.row.state==2">已就诊</span>
                                <span class="el-tag" style="color: white;width: 48px;height: 22px; text-align: center;"
                                      v-if="scope.row.state==-1">爽约</span>
                            </template>
                        </el-table-column>
                        <el-table-column label="操作" width="180">
                            <template scope="scope">
                                <div class="cell cell-blue">
                                    <i class="el-icon-document"></i>
                                    <span style="padding-right: 10px; color: #76BAF9">
                                        <router-link to="/booking/details">
                                                <span style="color: #76BAF9">详情</span>
                                        </router-link>
                                    </span>
...
<!--                                    <span v-if="scope.row.state==1">取消</span>-->
            ...
            <!--                    <span> <el-button icon="arrow-left"></el-button><el-input placeholder="本周"></el-input> <el-button-->
            <!--                        icon="arrow-right"></el-button></span>-->
            <!--                    <el-date-picker-->
            <!--                        v-model="value1"-->
            <!--                        type="date"-->
            ...
            <!--                    </el-select>-->
            <!--                    <i class="el-icon-search stateIcon"></i>-->
            <!--                    <router-link to="/booking/newAppoint"><i class="el-icon-plus stateIcon"-->
            <!--                                                             style="margin-left: 10px; "></i></router-link>-->
            <!--                </div>-->
            <!--                <div class="allAppoint allAppointRemain">-->
            <!--                    <div class="remainWeek">-->
            <!--                        <div class="remainDay" v-for="remain in remainNum">-->
            <!--                            <p style="border-bottom: 1px solid  #dfe6ec;padding-bottom: 10px;margin-bottom: 10px;font-weight: bold;">-->
            <!--                                {{ remain.day }}<br>{{ remain.date }}</p>-->
            <!--                            <el-button type="primary" size="mini" v-if="remain.num>0">余号量</el-button>-->
            <!--                            <el-button size="mini" v-if="remain.num>0">{{ remain.num }}</el-button>-->
            <!--                            <el-button size="mini" v-if="remain.num==0"-->
            <!--                                       style="background: rgb(182, 182, 182);border-color:#B6B6B6;color:#000;">余号量-->
            <!--                            </el-button>-->
            <!--                            <el-button size="mini" v-if="remain.num==0" style="border-color:#B6B6B6;color:#B6B6B6;">-->
            <!--                                {{ remain.num }}-->
            <!--                            </el-button>-->
            ...
            <!--                            <p style="border-bottom: 1px solid  #dfe6ec;padding-bottom: 10px;margin-bottom: 10px;padding-left: 10px;font-weight: bold;">-->
            <!--                                {{ money.actor }}</p>-->
            <!--                        </div>-->
