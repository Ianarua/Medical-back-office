                ...
                <div class="tabPancel" style="margin-bottom:30px;" v-show="selectTab==1">
                    <div class="tab-pancel-item">
                        ...
                        <div>
                            ...
                            <p>1、账号</p>
                            <p>A.
                                在使用本专家医生、医技设备、住院床位是医院最紧缺的医疗服务资源之一，全院统一预约管理系统可。</p>
                        </div>
                    </div>
                    <el-checkbox class="agreeCheckbox" v-model="agreeItem">同意《百慧云诊所服务条款》</el-checkbox>
                    <br/>
                            ...
                            <el-row>
                                ...
                                <el-col :span="12">
                                    ...
                                    <div style="min-height:50px;line-height:50px;height:auto;">
                                        ...
                                        <span
                                            style="color:#C3C3C3;font-size:14px;">(支持扩展名：.jpg .png大小不超过4MB)</span>
                                    </div>
                                </el-col>
                            </el-row>
                            <el-row>
                    ...
                    <div class="tab-pancel-item">
                        ...
                        <el-form class="infoForm">
                                ...
                                <el-col :span="12">
                                    ...
                                    <el-row>
                                        ...
                                        <div style="min-height:40px;line-height:40px;height:auto;">
                                            <span style="color:#20a0ff;font-size:16px;"><i
                                                class="fa fa-cloud-upload"></i>上传logo</span>
                                            <span
                                                style="color:#C3C3C3;font-size:14px;">(支持扩展名：.jpg .png大小不超过4MB)</span>
                                        </div>
                                    </el-row>
                            ...
                            <el-form-item label="诊所地址: ">
                                <el-select v-model="tabPancel3Info.address" clearable placeholder="请选择"
                                           stylw="width:100px;">
                                    <el-option
                    ...
                    <div class="tab-pancel-item">
                        ...
                        <el-form label-width="80px">
                            <el-form-item label="真实姓名：">
                                <el-input placeholder="请输入您的真实姓名，以便联系"
                                          v-model="tabPancel4Info.name"></el-input>
                            ...
                            <el-form-item label="联系电话：">
                                <el-input placeholder="请输入您常用的手机号码，以便联系"
                                          v-model="tabPancel4Info.tel"></el-input>
                            </el-form-item>
                            <el-form-item label="联系邮箱：">
                                <el-input placeholder="请输入您常用的电子邮箱，以便联系"
                                          v-model="tabPancel4Info.email"></el-input>
                                <label role="colored" v-if="tabPancel4Info.email===''"></label>
                                <label role="colored"
                                       v-else-if="!emailre.test(tabPancel4Info.email)">请输入正确的邮箱格式</label>
                                <label role="colorgreen" v-else><i class="fa fa-check-circle "></i></label>
                            </el-form-item>
                            <el-form-item label="设置用户名：">
                                <el-input placeholder="设置您的登录账号名，请使用大小写字母、数字组合"
                                          v-model="tabPancel4Info.username"></el-input>
                            </el-form-item>
                            <el-form-item label="设置密码：">
                                <el-input placeholder="设置您的登录密码，请使用6~16位大小写字母、数字组合"
                                          v-model="tabPancel4Info.pwd"
                                          type="password"></el-input>
                            </el-form-item>
                            <el-form-item label="重复密码：">
                                <el-input placeholder="重复输入您设置的登录密码" v-model="tabPancel4Info.secondPwd"
                                          type="password"></el-input>
                                <label role="colored" v-if="tabPancel4Info.secondPwd===''"></label>
                                <label role="colored"
                                       v-else-if="tabPancel4Info.secondPwd!==tabPancel4Info.pwd">两次密码不一样！</label>
                                <label role="colorgreen" v-else><i class="fa fa-check-circle "></i></label>
                            </el-form-item>
                        </el-form>
                    </div>
