<template>
    <div class="regFeeContainer">
        <div class="div-btn-add">
            <el-button @click="addDialogSeen=true" class="btn-add">
                <router-link to="/project/addItem"><span style="color: #fff">新增挂号费</span></router-link>
            </el-button>
        </div>
                    ...
                    <el-col :span="12">
                        <div class="type-table">
                            <el-card class="box-card">
                                ...
                                <div v-for="(typel,index) in typeList" :key="1" class="text item" style="wisth:100%;"
                                     @dblclick="handleEdit(typel,index)" :class="{selectDiv:markselect===index}">
                                    <el-row>
                            ...
                            <div class="table-footer">
                                <el-input style="top:8px;margin-right:5px;" placeholder="请输入"
                                          v-model="inputVal"></el-input>
                                <el-button type="primary" @click="saveChange(markselect)" class="save-btn">保存
                                </el-button>
                            </div>
                        </div>
                    </el-col>
