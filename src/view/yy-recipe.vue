...
<!--                    </el-col>-->
                    <!-- 处方信息 -->
                    <el-col :xs="4" :sm="6" :md="16" :lg="18" style="width: 100%;">
                        <div class="grid-content">
                            <div class="recipeMain">
                                <div class="recipePtMessage">
                                    <img src="../assets/yy/1.png">
                                    <span> {{ patientData.ptName }}   ({{ patientData.ptAge }}岁) </span>
<!--                                    <span style="float: right;margin-right: 10px;color:#1296db;"><i-->
<!--                                        class="icon-img icon-print"></i>打印处方</span>-->
                                </div>
                                ...
                                <div class="recipePtPills" style="border-bottom:1px solid #F2F2F2;padding-bottom:20px;">
                                    ...
                                    <div class="recipePtPillsTable">
                                        <el-table ref="multipleTable" :data="pillTable" border tooltip-effect="dark"
                                            ...
                                            <el-table-column label="名称(规格)" width="150">
                                                <template scope="scope">
                                                    <div style="display: inline-block;text-align: left;width: 100%">
                                                        <span
                                                            style="margin-left: -7px;line-height: 24px;color:#68696B;">{{
                                                                scope.row.pillName
                                                            }}</span>
                                                        <br>
                                                        <span style="margin-left: -10px;color:#D6D6D6;">{{
                                                                scope.row.pillSize
                                                            }}</span>
                                                    </div>
                                                </template>
                                        ...
                                        <!-- 开单医生 -->
                                        <div class="billedDr">
                                            <span style="color:#C6C2B6;">开单医生:</span><span style=""> {{
                                                billedDrs
                                            }} </span>
                                            <!-- 提交按钮 -->
                                            <div slot="footer" class="dialog-footer">
                                                <el-button @click="open3">审方不通过</el-button>
                                                <el-button type="success" @click="open2"
                                                           style="background: #21D180;color: #fff">审方通过
                                                </el-button>
                                            </div>
                                        </div>
                                    </div>
